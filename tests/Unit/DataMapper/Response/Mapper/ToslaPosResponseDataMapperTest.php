...
#[CoversClass(ToslaPosResponseDataMapper::class)]
...
class ToslaPosResponseDataMapperTest extends TestCase
{
    ...
    {
        $order  = ['currency' => PosInterface::CURRENCY_TRY, 'amount' => 1.01];
        $actual = $this->responseDataMapper->mapPaymentResponse([], PosInterface::TX_TYPE_PAY_AUTH, $order);
    ...
    public static function threeDPayPaymentDataProvider(): array
    {
        return [
            ...
            'half_3d_secure' => [
                ...
                'paymentData'  => [
                    'ClientId'            => '1000000494',
                    'OrderId'             => '20231203E149',
                    'MdStatus'            => '2',
                    'ThreeDSessionId'     => 'P2462E945F4554146B8E4A4306B7FF6C16D4047086D304B61B53430BD7CD02F52',
                    'BankResponseCode'    => 'MD:2',
                    'BankResponseMessage' => '',
                    'RequestStatus'       => '0',
                    'HashParameters'      => 'ClientId,ApiUser,OrderId,MdStatus,BankResponseCode,BankResponseMessage,RequestStatus',
                    'Hash'                => '',
                ...
                'expectedData' => [
                    ...
                    'tx_status'            => 'ERROR',
                    'md_error_message'     => null,
                    'order_id'             => '20231203E149',
                    'proc_return_code'     => 'MD:2',
                    'status'               => 'declined',
                    'error_code'           => 'MD:2',
                    'error_message'        => null,
                    'payment_model'        => '3d_pay',
    ...
    public static function statusResponseDataProvider(): Generator
    {
        ...
        yield 'fail_status' => [
            'responseData' => [
                ...
                'OrderId'                  => '202401199AAA',
                'BankResponseCode'         => '05',
                'BankResponseMessage'      => 'Do not honour',
                'AuthCode'                 => null,
                'HostReferenceNumber'      => null,
                'Amount'                   => 0,
                'Currency'                 => 0,
