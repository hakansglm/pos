...
#[CoversClass(GarantiPosResponseDataMapper::class)]
    ...
    public static function threeDPayPaymentDataProvider(): array
    {
        return [
            ...
            'half_3d_secure' => [
                ...
                'paymentData'  => [
                    'mdstatus'              => '2',
                    'mderrormessage'        => 'Kart kayıtlı değil',
                    'errmsg'                => 'Kart kayıtlı değil',
                    'clientid'              => '30691298',
                    'oid'                   => '2022110159A1',
                    'response'              => 'Error',
                    'procreturncode'        => '99',
                    'apiversion'            => 'v0.01',
                    'orderid'               => '2022110159A1',
                    'txninstallmentcount'   => '',
                    'terminaluserid'        => 'PROVAUT',
                    'secure3dhash'          => '',
                    'secure3dsecuritylevel' => '3D_PAY',
                ...
                'expectedData' => [
                    ...
                    'cavv'                 => null,
                    'error_code'           => '99',
                    'error_message'        => 'Kart kayıtlı değil',
                    'md_error_message'     => 'Kart kayıtlı değil',
                    'transaction_type'     => 'pay',
                    'payment_model'        => '3d_pay',
                    'installment_count'    => 0,
                    'transaction_time'     => null,
