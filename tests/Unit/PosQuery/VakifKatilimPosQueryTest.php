...
#[CoversClass(VakifKatilimPosQuery::class)]
#[CoversClass(AbstractMappedPosQuery::class)]
#[CoversClass(AbstractPosQuery::class)]
class VakifKatilimPosQueryTest extends TestCase
{
    private BoaPosAccount $account;

    private VakifKatilimPosQuery $posQuery;
    ...
    {
        $this->assertTrue(VakifKatilimPosQuery::supports(VakifKatilimPos::class));
        $this->assertFalse(VakifKatilimPosQuery::supports(AkbankPos::class));
    }

    public function testIsSupportedQuery(): void
    {
        $this->assertTrue(VakifKatilimPosQuery::isSupportedQuery(PosQueryInterface::QUERY_TYPE_CUSTOM_QUERY));
        $this->assertTrue(VakifKatilimPosQuery::isSupportedQuery(PosQueryInterface::QUERY_TYPE_HISTORY));
        $this->assertFalse(VakifKatilimPosQuery::isSupportedQuery(PosQueryInterface::QUERY_TYPE_INSTALLMENT_RATES));
        $this->assertFalse(VakifKatilimPosQuery::isSupportedQuery(PosQueryInterface::QUERY_TYPE_INSTALLMENT_PRICES));
        $this->assertFalse(VakifKatilimPosQuery::isSupportedQuery('unknown_query_type'));
    }
    ...
    public function testTestModeSetViaConfig(): void
    {
        ...
        $posQuery = new VakifKatilimPosQuery(
    ...
    public function testCustomQuery(): void
    {
        ...
        $requestData  = ['bin' => '415956', 'MerchantId' => '1'];
    ...
    private function createPosQuery(): VakifKatilimPosQuery
    {
        return new VakifKatilimPosQuery(
            [],
            $this->account,
            $this->requestMapperMock,
            $this->responseMapperMock,
