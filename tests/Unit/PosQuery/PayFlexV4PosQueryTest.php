...
class PayFlexV4PosQueryTest extends TestCase
{
    ...
    {
        $this->assertTrue(PayFlexV4PosQuery::supports(PayFlexV4Pos::class));
        $this->assertFalse(PayFlexV4PosQuery::supports(AkbankPos::class));
    }

    public function testIsSupportedQuery(): void
    {
        $this->assertTrue(PayFlexV4PosQuery::isSupportedQuery(PosQueryInterface::QUERY_TYPE_CUSTOM_QUERY));
        $this->assertFalse(PayFlexV4PosQuery::isSupportedQuery(PosQueryInterface::QUERY_TYPE_HISTORY));
        $this->assertFalse(PayFlexV4PosQuery::isSupportedQuery(PosQueryInterface::QUERY_TYPE_INSTALLMENT_RATES));
        $this->assertFalse(PayFlexV4PosQuery::isSupportedQuery(PosQueryInterface::QUERY_TYPE_INSTALLMENT_PRICES));
        $this->assertFalse(PayFlexV4PosQuery::isSupportedQuery('unknown_query_type'));
    }
    ...
    public function testTestModeSetViaConfig(): void
    {
        ...
        $posQuery = new PayFlexV4PosQuery(
    ...
    private function createPosQuery(): PayFlexV4PosQuery
    {
        return new PayFlexV4PosQuery(
            [],
            $this->account,
            $this->requestMapperMock,
            $this->httpClientStrategyMock,
