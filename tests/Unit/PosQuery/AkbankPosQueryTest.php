...
#[CoversClass(AkbankPosQuery::class)]
...
class AkbankPosQueryTest extends TestCase
{
    ...
    private AkbankPosQuery $posQuery;
    ...
    {
        $this->assertTrue(AkbankPosQuery::supports(AkbankPos::class));
        $this->assertFalse(AkbankPosQuery::supports(ToslaPos::class));
    }

    public function testIsSupportedQuery(): void
    {
        $this->assertTrue(AkbankPosQuery::isSupportedQuery(PosQueryInterface::QUERY_TYPE_CUSTOM_QUERY));
        $this->assertTrue(AkbankPosQuery::isSupportedQuery(PosQueryInterface::QUERY_TYPE_HISTORY));
        $this->assertFalse(AkbankPosQuery::isSupportedQuery(PosQueryInterface::QUERY_TYPE_INSTALLMENT_RATES));
        $this->assertFalse(AkbankPosQuery::isSupportedQuery(PosQueryInterface::QUERY_TYPE_INSTALLMENT_PRICES));
        $this->assertFalse(AkbankPosQuery::isSupportedQuery('unknown_query_type'));
    }
    ...
    public function testCustomQuery(): void
    {
        ...
        $requestData  = ['bin' => '415956', 'merchantSafeId' => '2023090417500272654BD9A49CF07574'];
    ...
    private function createPosQuery(): AkbankPosQuery
    {
        return new AkbankPosQuery(
            [],
            $this->account,
            $this->requestMapperMock,
            $this->responseMapperMock,
