...
#[CoversClass(PosNetV1PosQuery::class)]
#[CoversClass(AbstractPosQuery::class)]
class PosNetV1PosQueryTest extends TestCase
{
    private PosNetPosAccount $account;

    private PosNetV1PosQuery $posQuery;
    ...
    {
        $this->assertTrue(PosNetV1PosQuery::supports(PosNetV1Pos::class));
        $this->assertFalse(PosNetV1PosQuery::supports(AkbankPos::class));
    }

    public function testIsSupportedQuery(): void
    {
        $this->assertTrue(PosNetV1PosQuery::isSupportedQuery(PosQueryInterface::QUERY_TYPE_CUSTOM_QUERY));
        $this->assertFalse(PosNetV1PosQuery::isSupportedQuery(PosQueryInterface::QUERY_TYPE_HISTORY));
        $this->assertFalse(PosNetV1PosQuery::isSupportedQuery(PosQueryInterface::QUERY_TYPE_INSTALLMENT_RATES));
        $this->assertFalse(PosNetV1PosQuery::isSupportedQuery(PosQueryInterface::QUERY_TYPE_INSTALLMENT_PRICES));
        $this->assertFalse(PosNetV1PosQuery::isSupportedQuery('unknown_query_type'));
    }
    ...
    public function testCustomQuery(): void
    {
        ...
        $requestData  = ['bin' => '415956', 'MerchantNo' => '6700950031'];
    ...
    private function createPosQuery(): PosNetV1PosQuery
    {
        return new PosNetV1PosQuery(
            [],
            $this->account,
            $this->requestMapperMock,
            $this->httpClientStrategyMock,
