...
#[CoversClass(GarantiPosQuery::class)]
...
class GarantiPosQueryTest extends TestCase
{
    ...
    private GarantiPosQuery $posQuery;
    ...
    {
        $this->assertTrue(GarantiPosQuery::supports(GarantiPos::class));
        $this->assertFalse(GarantiPosQuery::supports(AkbankPos::class));
    }

    public function testIsSupportedQuery(): void
    {
        $this->assertTrue(GarantiPosQuery::isSupportedQuery(PosQueryInterface::QUERY_TYPE_CUSTOM_QUERY));
        $this->assertTrue(GarantiPosQuery::isSupportedQuery(PosQueryInterface::QUERY_TYPE_HISTORY));
        $this->assertTrue(GarantiPosQuery::isSupportedQuery(PosQueryInterface::QUERY_TYPE_BIN_LIST));
        $this->assertFalse(GarantiPosQuery::isSupportedQuery(PosQueryInterface::QUERY_TYPE_INSTALLMENT_RATES));
        $this->assertFalse(GarantiPosQuery::isSupportedQuery(PosQueryInterface::QUERY_TYPE_INSTALLMENT_PRICES));
        $this->assertFalse(GarantiPosQuery::isSupportedQuery('unknown_query_type'));
    }
    ...
    public function testCustomQuery(): void
    {
        ...
        $requestData  = ['bin' => '415956', 'MerchantID' => '7000679'];
    ...
    {
        $params      = [];
        $requestData = ['Mode' => 'PROD', 'Transaction' => ['Type' => 'bininq']];
    ...
    public static function binListResponseDataProvider(): array
    {
        return [
            'approved' => [
                ['BINInqResult' => ['BINList' => []]],
                ['status' => 'approved', 'bin_list' => []],
                true,
            ],
            'declined' => [
                ['Transaction' => ['Response' => ['Code' => '99']]],
    ...
    private function createPosQuery(): GarantiPosQuery
    {
        return new GarantiPosQuery(
            [],
            $this->account,
            $this->requestMapperMock,
            $this->responseMapperMock,
