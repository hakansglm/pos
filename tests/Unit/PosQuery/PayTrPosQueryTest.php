...
#[CoversClass(PayTrPosQuery::class)]
...
class PayTrPosQueryTest extends TestCase
{
    ...
    private PayTrPosQuery $posQuery;
    ...
    {
        $this->assertTrue(PayTrPosQuery::supports(PayTrPos::class));
        $this->assertFalse(PayTrPosQuery::supports(AkbankPos::class));
    }

    public function testIsSupportedQuery(): void
    {
        $this->assertTrue(PayTrPosQuery::isSupportedQuery(PosQueryInterface::QUERY_TYPE_CUSTOM_QUERY));
        $this->assertTrue(PayTrPosQuery::isSupportedQuery(PosQueryInterface::QUERY_TYPE_HISTORY));
        $this->assertTrue(PayTrPosQuery::isSupportedQuery(PosQueryInterface::QUERY_TYPE_INSTALLMENT_RATES));
        $this->assertTrue(PayTrPosQuery::isSupportedQuery(PosQueryInterface::QUERY_TYPE_BIN_LIST));
        $this->assertFalse(PayTrPosQuery::isSupportedQuery(PosQueryInterface::QUERY_TYPE_INSTALLMENT_PRICES));
        $this->assertFalse(PayTrPosQuery::isSupportedQuery('unknown_query_type'));
    }
    ...
    public function testCustomQuery(): void
    {
        ...
        $requestData  = ['bin' => '415956', 'merchant_id' => '123456'];
    ...
    {
        $params      = ['bin' => '415956'];
        $requestData = ['merchant_id' => '123456', 'bin' => '415956'];
    ...
    {
        $params      = ['bin' => '415956'];
        $requestData = ['merchant_id' => '12345', 'bin_number' => '415956', 'paytr_token' => 'tok'];
    ...
    public static function binListResponseDataProvider(): array
    {
        return [
            'approved' => [
                ['status' => 'success', 'cardType' => 'credit', 'schema' => 'VISA'],
                ['status' => 'approved', 'bin_list' => [['card_type' => 'credit', 'organization' => 'VISA']]],
                true,
            ],
            'declined' => [
                ['status' => 'failed'],
    ...
    private function createPosQuery(): PayTrPosQuery
    {
        return new PayTrPosQuery(
            [],
            $this->account,
            $this->requestMapperMock,
            $this->responseMapperMock,
